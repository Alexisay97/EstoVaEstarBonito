...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-10-2019 a las 23:42:28
...
CREATE TABLE `descargo` (
  ...
  `Estado` varchar(14) COLLATE utf8_spanish_ci NOT NULL,
  `idUser` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `descargo` (`id`, `cod`, `fDescargo`, `cant`, `pUnitario`, `tipo`, `Estado`, `idUser`) VALUES
(1, '5', '2019-10-20 19:47:35', 2, 2, 'Shampoo', '', 1),
(2, '2', '2019-10-21 04:11:31', 2, 2, 'Shampoo', '', 1),
(3, '1234567891234', '2019-10-22 22:36:33', -1, 2, 'Shampoo', 'Descargado', 1),
(4, '1234567891234', '2019-10-22 22:40:16', 2, 2, 'Shampoo', 'Descargado', 1);
...
(5, '1234567891234', 'Head & Soulders', 'Shampoo', 2, 'Shampoo Anticaspa con  olor limon fresco', 2, 'Activo', '2019-10-19', '2019-10-20 17:37:43', 1),
